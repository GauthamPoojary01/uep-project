  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-b from-[#10074e] to-[#1E3C72] text-blue-900">
      <div className="bg-[#EDEDF3] rounded-lg p-6 text-center w-80">
        ...
        <Link href="/forgot-password" className="block text-right text-xs text-gray-500 hover:underline">
  Forgot Password?
</Link>


        <button
          className="bg-[#1e3c72] hover:bg-[#4c4d85] text-white p-2 rounded w-full mt-4"
          onClick={handleLogin}
        >
